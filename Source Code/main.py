...
img = PhotoImage(file="./images/main_exp_2.png")
label1.configure(image=img)

button1 = Button(main)
button1.place(relx=0.316, rely=0.446)
...
img2 = PhotoImage(file="./images/employee_button.png")
button1.configure(image=img2)
button1.configure(command=emp)

button2 = Button(main)
button2.place(relx=0.566, rely=0.448)
...
img3 = PhotoImage(file="./images/Admin_button.png")
